<table style="width:100%" id="dataTable2" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;" >
                <a class='btn btn-danger btn-sm btn-rounded btn_hapus_diskon' nama_diskon="<?php echo $row->nama_diskon; ?>" kode_diskon="<?php echo $row->kode_diskon; ?>" gambar_diskon="<?php echo $row->gambar_diskon; ?>"><span class="bx bx-fw bxs-trash"></span></a>
            </td>
        </tr>
        <?php
            $no1++;
